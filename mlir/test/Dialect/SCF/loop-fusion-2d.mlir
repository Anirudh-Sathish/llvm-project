  ...
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %c2 step %c1 {
      scf.for %arg1 = %c0 to %c3 step %c1 {
        ...
        %3 = memref.load %1[%arg0, %arg1] : memref<2x3xf32>
        %4 = arith.addf %2, %3 : f32
        memref.store %4, %alloc_0[%arg0, %arg1] : memref<2x3xf32>
      }
    }
    %cast = memref.cast %alloc : memref<2x3xf32> to memref<*xf32>
    %cast_1 = memref.cast %alloc_0 : memref<2x3xf32> to memref<*xf32>
    call @printMemrefF32(%cast) : (memref<*xf32>) -> ()
    call @printMemrefF32(%cast_1) : (memref<*xf32>) -> ()
    memref.dealloc %alloc : memref<2x3xf32>
    memref.dealloc %alloc_0 : memref<2x3xf32>
    return
  }
}
...
//CHECK-NEXT: %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<2x3xf32>
...
//CHECK-NEXT:     %6 = memref.load %1[%arg0, %arg1] : memref<2x3xf32>
//CHECK-NEXT:     %7 = arith.addf %5, %6 : f32
//CHECK-NEXT:     memref.store %7, %alloc_0[%arg0, %arg1] : memref<2x3xf32>
//CHECK-NEXT:   }
//CHECK-NEXT: }